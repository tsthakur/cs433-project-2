...
class LogReader:
    ...
    def __init__(self, logFilePath):
        ...
        thermoTitles = logData[
            thermoTitlesStartIndices[0] : thermoTitlesEndIndex
        ].split()
        ...
        lineBelowThermoIndices = [
            m.start() - 2
            for m in re.finditer(endMarker, logData)  # -2 to remove \n and space
        ]
    ...
    def get_header(self, columnName):
        ...
        if not isinstance(columnName, str):
            raise TypeError(
                f"Argument columnName is of type {type(columnName)}, must be of type str"
            )
